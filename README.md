...
Normally, as a professional software developer, i do not do stuff like that. Instead i usually invest the time and do it right. And in the rare cases i am forced to, i do not post this on GitHub :) But i needed a quick code sharing platform, and GitHub was just one click away. But aside from all that, there is a reason (and you should read that carefully, because it is important) why i do not care about in this case:
