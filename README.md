...
Normally, as a professional software developer, i do not do stuff like that. Instead i invest the time and do it right. But there is a reason (and you should read that carefully, because it is important) why i do not care about in this case:
